...
export const PRODUTO_ROLES = [ROLES.ROOT, ROLES.ADMIN, ROLES.GERENTE, ROLES.COZINHEIRO, ROLES.GARCON];
export const BAR_ROLES     = [ROLES.ROOT, ROLES.ADMIN, ROLES.GERENTE, ROLES.GARCON];
